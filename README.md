...
🤖 Бот: Выберите действие:
      [📝 Добавить продажу] [📊 Статистика]

👤 Пользователь: [нажимает 📊 Статистика]
🤖 Бот: 📈 Статистика за сегодня (04.11.2024)
      
      Продано: 450 шт.
      Выручка: 1,250,000 сум
      Чистая прибыль: 450,000 сум
      
      Топ-3 продукта:
      1. 🥖 Хлеб белый — 150 шт. (333,000 сум)
      2. 🍞 Багет — 80 шт. (240,000 сум)
      3. 🥐 Круассан — 120 шт. (180,000 сум)
```
...
5. **Настройте UptimeRobot** для предотвращения "засыпания"

### Health Check

Бот автоматически запускает Express-сервер для health checks:

```
GET https://your-app.onrender.com/health
→ { "status": "ok", "timestamp": "2024-11-04T12:00:00.000Z" }
```
...
- 🐛 Сообщите о багах через [Issues](https://github.com/S7L5An/piestat-bot/issues)
...
*Автоматизируйте учет — развивайте бизнес!*
